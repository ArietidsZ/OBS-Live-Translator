            ...
            DemoScript {
                ...
                segments: vec![
                    DemoSegment {
                        ...
                        original_text: "大家好，欢迎来到AI技术峰会。今天我们将讨论大语言模型的最新进展。".to_string(),
                    ...
                    DemoSegment {
                        ...
                        original_text: "私たちの研究では、リアルタイム翻訳の精度が98%に達しました。これは画期的な成果です。".to_string(),
                        emotion: Emotion::Professional,
                        tone: Tone::Serious,
                        speed: 0.9,
                    },
            ...
            DemoScript {
                ...
                segments: vec![
                    ...
                    DemoSegment {
                        ...
                        language: "ja-JP".to_string(),
                        original_text: "アジア市場では、リアルタイム翻訳機能が特に重要視されています。遅延を50ミリ秒以下に抑える必要があります。".to_string(),
    ...
    fn simulate_translation(segment: &DemoSegment) -> String {
        ...
        match segment.language.as_str() {
            "zh-CN" => match segment.speaker.as_str() {
                "Dr. Wang" => "Hello everyone, welcome to the AI Technology Summit. Today we'll discuss the latest advances in large language models.".to_string(),
            ...
            "ja-JP" => match segment.speaker.as_str() {
                ...
                "市場部長" => "In the Asian market, real-time translation is particularly important. We need to keep latency below 50 milliseconds.".to_string(),
                "Tanaka-san" => "Our research has achieved 98% accuracy in real-time translation. This is a breakthrough achievement.".to_string(),
                _ => "Translation in progress...".to_string(),
            },
